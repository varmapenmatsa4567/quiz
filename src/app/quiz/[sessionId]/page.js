    ...
    return (
        ...
        >
            <div className="text-center mb-12">
                <h1 className="text-3xl md:text-5xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                    {quiz.topic}
                </h1>
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="text-xl md:text-2xl font-bold mb-8 leading-relaxed">
...
function ResultsView({ session, quiz, user, playVictory }) {
    ...
    return (
        ...
        >
            <h1 className="text-4xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                Quiz Completed!
            </h1>
